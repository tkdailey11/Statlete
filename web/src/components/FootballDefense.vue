    ...
    <div class="footballDefense">
             ...
             <div id="runDefForm">
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td><input align="right" type="text" maxlength="2" size="3" name="tacklePlayerNumber">
                        </td>
                    </tr>
                        <tr>
                            <td>Offensive Yards: </td><td><input alilgn="right" type="text" maxlength="3" size="3" name="yards"></td></tr>
                            <tr><td>Touchdown </td><td><input type="checkbox" name="touchdown">
                            </td></tr>
                            <tr><td>QB Sack</td><td><input align="right" type="checkbox" name="sack"></td>
                ...
                <table align="center"><tr><td>Fumble:</td><td><input type="checkbox" name="turnoverType" value="fumble" checked>
                </td></tr>
            ...
            <div id="passDefForm">
                <table align="center">
                    ...
                    <tr><td>Completion: </td><td><input type="checkbox" name="completePass">
                    </td></tr>
                    <tr>
                        <td> Tackle by Player: </td>
                        <td><input align="right" type="text" maxlength="2" size="3" name="tacklePlayerNumber">
                        </td></tr>
                    <tr><td>Offensive Yards: </td><td><input type="text" maxlength="3" size="3" name="yards">
                    </td></tr>
                    <tr><td>Touchdown </td><td><input type="checkbox" name="touchdown">
                    </td></tr>
                    <tr><td>QB Sack</td><td><input align="right" type="checkbox" name="sack"></td>
                    ...
                    <div id="turnoverForm">
                <table align="center"><tr><td>Fumble:</td><td><input type="radio" name="turnoverType" value="fumble" checked>
                </td></tr><tr><td>Interception:</td><td>
                  <input type="radio" name="turnoverType" value="interception"></td></tr>
                  <tr><td>Turnover By: </td><td><input type="text" name="turnoverNumber" maxlength="2" size="2"></td></tr>
                  </table>
            </div>
            ...
            <div id="penaltyDefForm">
                      <table align="center"><tr><td>Penalty: </td><td>
                        ...
                        <input type="text" size="2" maxlength="2" name="yards"></td></tr>
                        <tr><td>Down: </td><td>
                        <input type="text" size="2" maxlength="1" name="down"></td></tr>                        
                        <tr><td>Spot of Ball</td><td><input type="text" size="2" maxlength="2" name="spot">
                        </td></tr>
                        </table>
